...
# compute_f810 は import するが FEATURE_FNS には入れない（D-166）
from umagic.features.f810 import compute_f810  # noqa: F401
...
CATEGORY_COLUMNS = frozenset({
    ...
    # "f810_owner_id" は D-166 により FEATURE_FNS から除外。カテゴリ登録も外す
})
