...
| ドキュメント | 内容 |
|---|---|
| [`docs/decisions.md`](./docs/decisions.md) | 確定した設計判断とその根拠（D-001〜D-009） |
...
| [`docs/open-questions.md`](./docs/open-questions.md) | 未決事項（Q-001〜Q-009） |
...
`docs/open-questions.md` の **Q-001（データ取得の可否確認）** が着手のブロッカー。
